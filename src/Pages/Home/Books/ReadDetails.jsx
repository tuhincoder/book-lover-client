              ...
              <div className="p-8 md:p-16">
                ...
                <div className="prose prose-lg max-w-none text-slate-600 leading-relaxed space-y-6">
                  ...
                  <p>
                    ...
                    of emotions, adventures, and discoveries, lies the essence
                    of our stories. From the quiet corners of introspection to
                    the thunderous clash of epic battles, literature serves as a
                  ...
                  <div className="bg-slate-50 p-10 rounded-[20px] relative my-12">
                    ...
                    <p className="relative z-10 text-2xl font-serif text-[#052c65] italic">
                      "A book is a dream that you hold in your hands. Through
                      the written word, we traverse distant lands and unlock the
                      secrets of our own souls."
                    </p>
                  </div>

                  <p>
                    Each page turned is a journey embarked upon, a doorway
                    opened to new worlds and possibilities. Within these bound
                    volumes, we find solace, inspiration, and the timeless
                    wisdom of generations past. For in the pages of books, we
                    discover not only the stories of others but also the echoes
                    of our own souls.
                  </p>
                </div>
